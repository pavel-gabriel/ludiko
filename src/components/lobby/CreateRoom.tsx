  ...
  return (
    <div className="page">
      <div className="card w-full max-w-md relative">
        ...
        {/* Mode & Rounds/Time Group */}
        <div className="border border-gray-200 rounded-xl p-3 mb-6 space-y-3">
          {/* Game mode selector */}
          {showModeSelector && (
            <label className="block">
          ...
          <div className="grid grid-cols-2 gap-4">
            <label className="block">
              ...
              <input
                ...
                className="mt-1 w-full px-4 py-2 rounded-xl border-2 border-gray-200 focus:outline-none focus:border-ludiko-purple"
              />
            </label>
            <label className="block">
              <span className="text-sm font-semibold">
